  ...
  return (
    <>
      ...
      <PageHero
        ...
        intro={`${c.summary} We are a Michigan company. The people who quote your bathroom are the people who build it, and we know what sits behind the walls in ${c.name} homes because we have opened a great many of them.`}
      />
      ...
      <Section tone="white">
        <SectionHead
          ...
          intro="This is not a template with a city name dropped into it. It is what the housing stock here is genuinely built from, and how that changes the work."
        />
      ...
      <Section tone="white">
        <div className="flex flex-wrap items-end justify-between gap-6">
          <SectionHead
            eyebrow="Finishes"
            title="Finishes we install."
            intro="Three solid surface tiers and more than twenty finishes, with the physical samples brought to your house."
          />
          <Link
            href="/contact"
